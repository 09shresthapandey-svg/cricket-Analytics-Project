...
# ----------------------------
# 3️⃣ 10 Visualizations
# ----------------------------

# 1️⃣ Distribution of runs_off_bat
...
# 2️⃣ Number of wickets per match
...
# 3️⃣ Top 10 batsmen by total runs
...
# 6️⃣ Balls vs runs scatter (strike rate like)
plt.figure(figsize=(8,5))
...
# 9️⃣ Correlation heatmap of numeric features
